...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Contacts",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface Contact (SWIFT_EXTENSION(Contacts))
@property (nonatomic, copy) NSString * _Nullable firstName;
@property (nonatomic, copy) NSString * _Nullable lastName;
@property (nonatomic, copy) NSString * _Nullable phone;
@property (nonatomic, copy) NSString * _Nullable email;
@property (nonatomic, copy) NSString * _Nullable notes;
@property (nonatomic, strong) NSData * _Nullable rawImage;
@end
...
@interface ContactDetailViewController : UIViewController <UIImagePickerControllerDelegate, UINavigationControllerDelegate>
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified imageView;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified firstLabel;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified phoneLabel;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified emailLabel;
@property (nonatomic, weak) IBOutlet UITextView * _Null_unspecified notesText;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified lastLabel;
- (void)viewDidLoad;
- (IBAction)save:(id _Nonnull)sender;
- (IBAction)cameraWasClicked:(id _Nonnull)sender;
...
@interface ContactDetailViewController (SWIFT_EXTENSION(Contacts)) <UITextFieldDelegate>
...
SWIFT_CLASS("_TtC8Contacts22ContactsViewController")
@interface ContactsViewController : UIViewController <UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified contactsTableView;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC8Contacts13SceneDelegate")
